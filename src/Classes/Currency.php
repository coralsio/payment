...
class Currency
{
     ...
     * @throws InvalidRequestException
     */
    public function getAmountISOCurrency($amount, $currencyCode = null)
    {
        return $this->getMoneyISOCurrency($amount, $currencyCode)->getAmount();
    }
     ...
     * Get storage driver.
     *
     * @return \Corals\Modules\Payment\Common\Contracts\DriverInterface
     */
     ...
     *
     * @return \Corals\Modules\Payment\Common\Contracts\FormatterInterface
     */
