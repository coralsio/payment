        ...
        <tr>
            ...
            <td style="width: 35%; vertical-align: top;">
                ...
                @if($invoice->reference_id)
                    <strong>@lang('Payment::labels.invoice.reference_id'):</strong> {{ $invoice->reference_id }}<br>
                @endif
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td style="width:50%;vertical-align: top;">
                ...
                <hr/>
                {!! $invoice->invoicable && method_exists($invoice->invoicable, 'getInvoicePayableTo') ? $invoice->invoicable->getInvoicePayableTo() : \Settings::get('payable_to','-') !!}
            </td>
            <td style="width:50%;vertical-align: top;">
